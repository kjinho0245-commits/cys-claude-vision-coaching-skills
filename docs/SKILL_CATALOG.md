...
> 본 파일은 *자동 생성 인덱스 표*만 보관하는 짧은 부록입니다 (외부 링크 호환성 유지용).
>
> **📍 The full catalog — 8-stage flow diagram, per-user packages, detailed cards — is consolidated into [../README.md](../README.md).**
> This file keeps only the *auto-generated index tables* as a slim appendix (for external link compatibility).
